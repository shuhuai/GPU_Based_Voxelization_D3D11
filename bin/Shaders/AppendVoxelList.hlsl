...
//
// HLSL file for appending voxel data to a ouput buffer
//--------------------------------------------------------------------------------------

#include "voxel.fx"	// vertex format header file
...
{
	// Using DispatchThreadID to access an address of Texture3D
