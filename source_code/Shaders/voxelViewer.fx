...
cbuffer cbPerFrame : register(b0)
{
	...
	float gVoxelScale;		// The size of every voxel.
};
...
struct GS_OUT
{
	...
	float3 worldNormal		: Position;		// A surface normal for lighting cubes.
	float3 Normal			: NORMAL;		// A surface normal of voxel data.
...
//--------------------------------------------------------------------------------------
// Pixel shader to show different voxel data.
//--------------------------------------------------------------------------------------

// Show surface normal data.
